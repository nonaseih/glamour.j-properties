export const properties = [
  {
    ...
    feesNote: 'All further fees will be discussed after inspection',
    agent: 1,
  },
  {
    id: 8,
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'Standard fees include: Caution Deposit (refundable at end of tenancy if there are no damages or outstanding service charges), Agency Fee (10% of annual rent), and Legal/Agreement Fee (10% of annual rent). All fees are clearly stated before you commit to anything. For an exclusive physical tour of 5+ properties, a charge of ₦100,000 applies. Optional and please general inspecti fee applies.',
  },
  {
    id: 5,
    category: 'Costs',
