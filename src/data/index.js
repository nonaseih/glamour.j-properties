export const properties = [
  {
    ...
    amenities: [
      'Smart Home System', 'Swimming Pool', 'Gym', 'Cinema Room',
      'Elevator', 'Full CCTV', 'Smart Kitchen WiFi', 'BQ',
      'Smart Door Locks', 'Internal Speakers', 'Backup Generator',
      'Security House', '4 Living Rooms', 'Spacious Compound',
      'ACs Throughout', 'Ultramodern Design',
    ],
    description:
      'An extraordinary 8-bedroom smart estate reserved for diplomats, ambassadors and corporate leaders. Fully automated from kitchen to security — set in the heart of Asokoro.',
  ...
  },
  {
    ...
    description:
      'A stunning 5-bedroom fully detached duplex with a room BQ in a secure mini estate at Guzape. A rare distress opportunity — exceptional finish, priced to move.',
    annualRent: 750000000,
    cautionFee: 750000000,
    agencyFee: 37500000,
    legalFee: 18750000,
    agent: 2,
  },
  {
    id: 9,
    title: 'Furnished 4-Bed Terrace Duplex',
    ...
    description:
      'A beautifully furnished 4-bedroom terrace duplex with a room BQ in Katampe Extension. Reduced from ₦550M — a rare deal at exceptional value.',
    annualRent: 500000000,
    cautionFee: 500000000,
    agencyFee: 25000000,
    legalFee: 12500000,
    agent: 1,
  },
